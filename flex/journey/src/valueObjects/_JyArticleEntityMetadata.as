...
[ExcludeClass]
internal class _JyArticleEntityMetadata extends AbstractEntityMetadata
{
	private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("describe", "content", "title", "articleid", "useremail", "adddate", "userid", "comment", "serial", "partyid");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("describe", "content", "title", "articleid", "useremail", "adddate", "userid", "comment", "serial", "partyid");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("describe", "content", "title", "articleid", "useremail", "adddate", "userid", "comment", "serial", "partyid");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("describe", "content", "title", "articleid", "useremail", "adddate", "userid", "comment", "serial", "partyid");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;    
    model_internal static var entityName:String = "JyArticle";
    model_internal static var dependentsOnMap:Object;    
    model_internal static var dependedOnServices:Array =  new Array();
    
    
    model_internal var _instance:_Super_JyArticle;
    model_internal static var _nullStyle:Style = new Style();
    
    public function _JyArticleEntityMetadata(jyArticle : _Super_JyArticle)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["describe"] = new Array();
            model_internal::dependentsOnMap["content"] = new Array();
            model_internal::dependentsOnMap["title"] = new Array();
            model_internal::dependentsOnMap["articleid"] = new Array();
        ...
        model_internal::_instance = jyArticle;     
    }
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity JyArticle");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
       if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity JyArticle");  
     ...
     override public function getValue(propertyName:String):Object    
     {
         ...
         {
         	throw new Error(propertyName + " does not exist for entity JyArticle");
         }     
    ...
    public function get isValid() : Boolean
    {
     ...
     [Bindable(event="propertyChange")] 
     public function get isDescribeAvailable():Boolean
     {
        return true;
     }                       
     ...
     [Bindable(event="propertyChange")] 
     public function get isArticleidAvailable():Boolean
     {
        return true;
     }                       
    ...
    [Bindable(event="propertyChange")]   
    public function get describeStyle():Style
    {
    ...
    [Bindable(event="propertyChange")]   
    public function get articleidStyle():Style
    {
		return model_internal::_nullStyle;		
    }      
    ...
    [Bindable(event="propertyChange")]   
    public function get commentStyle():Style
    {
		return model_internal::_nullStyle;		
    }      
    
    [Bindable(event="propertyChange")]   
    public function get serialStyle():Style
    {
		return model_internal::_nullStyle;		
    }      
