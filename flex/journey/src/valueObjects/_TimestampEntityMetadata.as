...
internal class _TimestampEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("nanos", "time", "minutes", "seconds", "hours", "month", "year", "timezoneOffset", "day", "date");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("nanos", "time", "minutes", "seconds", "hours", "month", "year", "timezoneOffset", "day", "date");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("nanos", "time", "minutes", "seconds", "hours", "month", "year", "timezoneOffset", "day", "date");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("nanos", "time", "minutes", "seconds", "hours", "month", "year", "timezoneOffset", "day", "date");
