...
[ExcludeClass]
public class _Super_JyPhoto extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void 
    {
        try 
        {
            if (flash.net.getClassByAlias("journey.model.JyPhoto") == null)
            {
                flash.net.registerClassAlias("journey.model.JyPhoto", cz);
            } 
        }
        catch (e:Error) 
        {
