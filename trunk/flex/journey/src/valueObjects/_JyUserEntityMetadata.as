...
[ExcludeClass]
internal class _JyUserEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
	private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("email", "userid", "password");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("email", "userid", "password");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("email", "userid", "password");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("email", "userid", "password");
