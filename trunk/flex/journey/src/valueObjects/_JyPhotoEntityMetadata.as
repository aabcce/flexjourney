...
[ExcludeClass]
internal class _JyPhotoEntityMetadata extends AbstractEntityMetadata
{
	private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("describe", "title", "useremail", "adddate", "userid", "comment", "serial", "partyid", "photoid");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("describe", "title", "useremail", "adddate", "userid", "comment", "serial", "partyid", "photoid");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("describe", "title", "useremail", "adddate", "userid", "comment", "serial", "partyid", "photoid");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("describe", "title", "useremail", "adddate", "userid", "comment", "serial", "partyid", "photoid");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;    
    model_internal static var entityName:String = "JyPhoto";
    model_internal static var dependentsOnMap:Object;    
    model_internal static var dependedOnServices:Array =  new Array();
    
    
    model_internal var _instance:_Super_JyPhoto;
    model_internal static var _nullStyle:Style = new Style();
    
    public function _JyPhotoEntityMetadata(jyPhoto : _Super_JyPhoto)
    {
        ...
        model_internal::_instance = jyPhoto;     
    }
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity JyPhoto");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
       if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity JyPhoto");  
     ...
     override public function getValue(propertyName:String):Object    
     {
         ...
         {
         	throw new Error(propertyName + " does not exist for entity JyPhoto");
         }     
    ...
    [Bindable(event="propertyChange")]   
    public function get photoidStyle():Style
    {
		return model_internal::_nullStyle;		
    }      
